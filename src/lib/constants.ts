...
export const INSURANCE_COMPANIES = [
  ...
  { name: "Jordan Islamic Bank",  logo: "/images/insurance/jordan-islamic-bank-insurance.png", category: "banks", shape: "wide" },
  ...
  { name: "safwa bank",  logo: "/images/insurance/safwa-bank.png", category: "banks", shape: "wide" },
...
// عنوان صفحة /approved-partners الكاملة — منفصل عن عنوان قسم الصفحة
// الرئيسية أعلاه (الصفحة الكاملة بلا وصف تحته، فقط عنوان + LeafDivider)
export const APPROVED_PARTNERS_PAGE = {
