...
export const HERO_SECTION = {
  description: 'منذ عام 1981، تقدّم صيدلية عدنان رعاية صيدلانية موثوقة لأهالي المنطقة، من خلال استشارات صحية دقيقة، وتوفير الأدوية ومستحضرات العناية والمكملات الصحية من علامات تجارية موثوقة، بخبرة طويلة واهتمام حقيقي بكل من يزورنا.',
} as const
