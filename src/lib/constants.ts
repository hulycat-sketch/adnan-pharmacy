...
export const HERO_SECTION = {
  description: 'نجمع بين الخبرة والاهتمام لنقدم لكم رعاية صيدلانية موثوقة تلبي احتياجاتكم الصحية اليومية.',
} as const
...
// -----------------------------------------------------------------------------
// 6ب. تحليلات الموقع — Google Analytics 4
// -----------------------------------------------------------------------------
export const ANALYTICS = {
  googleAnalyticsId: 'G-P871XV3E25',
} as const
...
// -----------------------------------------------------------------------------
export const SEO = {
  defaultTitle:       'صيدلية عدنان | منذ عام 1981',
  defaultDescription: 'منذ عام 1981، نعتز بتقديم رعاية صيدلانية موثوقة وخدمات صحية متخصصة لأهالي إربد، مع فحص البشرة والتعامل مع العديد من شركات التأمين.',
  keywords: [
    'صيدلية عدنان',
    'صيدلية في إربد',
    'فحص البشرة إربد',
...
// -----------------------------------------------------------------------------
// 8أ. التواصل السريع — بطاقات "اتصال / واتساب / ماسنجر" بصفحة /contact
// -----------------------------------------------------------------------------
...
export const INSURANCE_COMPANIES = [
  { name: "GIG Jordan", logo: "/images/insurance/gign.png", category: "insurance", shape: "medium", scale: 1.4, visualScale: 0.8, marqueeCompact: true, featured: true },
  ...
  { name: "Arab Bank",  logo: "/images/insurance/arab-bank2.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/arab-bank2.png", featured: true },
  { name: "Al Rajhi Bank",  logo: "/images/insurance/alrajhi-bank1.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/alrajhi-bank1.png", featured: true },
  { name: "Housing Bank", logo: "/images/insurance/housing-bank-insurance.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/housing-bank-insurance.png", featured: true },
  { name: "Jordan Islamic Bank",  logo: "/images/insurance/jordan-islamic-bank-insurance.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/jordan-islamic-bank-insurance.png" },
  { name: "Cairo Amman Bank",  logo: "/images/insurance/cairo-amman-bank.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/cairo-amman-bank.png" },
  { name: "bank aletihad",  logo: "/images/insurance/bank-aletihad.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/bank-aletihad.png" },
  { name: "safwa bank",  logo: "/images/insurance/safwa-bank.png", category: "banks", shape: "wide", visualScale: 1.35, marqueeLogo: "/images/insurance-marquee/safwa-bank.png", featured: true },
  { name: "yarmouk university",  logo: "/images/insurance/yarmouk-university.png", category: "universities", shape: "square", marqueeLogo: "/images/insurance-marquee/yarmouk-university.png", marqueeScale: 1.1, featured: true },
  { name: "jadara university",  logo: "/images/insurance/jadara-university.png", category: "universities", shape: "square", scale: 1.15, marqueeLogo: "/images/insurance-marquee/jadara-university.png", marqueeScale: 1.1, featured: true },
...
export const APPROVED_PARTNERS_MARQUEE_LOGOS = [
  ...
  { name: "NatHealth", logo: "/images/insurance-marquee/nathealth3.png", type: "wide", visualScale: 1.15 },
  ...
  { name: "Dental Association", logo: "/images/insurance-marquee/dental-association.png", type: "compact", scale: 1.1, visualScale: 1.25 },
...
export const INSURANCE_SECTION = {
  ...
  subtitle: 'نتعامل مع مجموعة واسعة من شركات التأمين والبنوك والجامعات والنقابات، لتسهيل حصولكم على خدماتنا.',
} as const
