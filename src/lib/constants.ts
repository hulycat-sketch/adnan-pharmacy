...
export const ABOUT_TODAY = {
  ...
  description: 'اليوم يواصل الدكتور محمد عدنان المومني مسيرة والده، محافظًا على القيم التي وضعها المؤسس، ومواكبًا احتياجات المراجعين بأسلوب مهني يجمع بين الخبرة والرعاية الشخصية.',
  image:       IMAGES.hero,
...
export const ABOUT_LEGACY = {
  title:       'إرث يستمر',
  description: 'تغيّرت الواجهة وتطورت الخدمات، لكن يبقى وعدنا ثابتًا: معرفة صيدلانية موثوقة، وتعامل واضح وأمين، واهتمام حقيقي بكل من يزورنا.',
  facts: [
